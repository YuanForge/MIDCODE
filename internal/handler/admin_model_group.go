...
func CreateModelGroup(c *gin.Context) {
	...
	group := model.ModelGroup{Code: req.Code, Name: req.Name, Description: req.Description, IsActive: req.IsActive}
...
func UpdateModelGroup(c *gin.Context) {
	...
	group := model.ModelGroup{ID: id, Code: req.Code, Name: req.Name, Description: req.Description, IsActive: req.IsActive}
