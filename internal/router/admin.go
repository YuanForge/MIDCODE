...
func registerAdminRoutes(authed *gin.RouterGroup, deps Dependencies) {
	...
	admin.Use(middleware.Admin())
	{
		...
		admin.GET("/model-official-prices", handler.ListModelOfficialPrices)
		admin.POST("/model-official-prices", handler.CreateModelOfficialPrice)
		admin.PUT("/model-official-prices/:id", handler.UpdateModelOfficialPrice)
		admin.PATCH("/model-official-prices/:id/status", handler.SetModelOfficialPriceStatus)
		admin.DELETE("/model-official-prices/:id", handler.DeleteModelOfficialPrice)
		admin.GET("/model-groups", handler.ListModelGroups)
		admin.POST("/model-groups", handler.CreateModelGroup)
		admin.PUT("/model-groups/:id", handler.UpdateModelGroup)
		admin.PATCH("/model-groups/:id/toggle", handler.ToggleModelGroup)
		admin.DELETE("/model-groups/:id", handler.DeleteModelGroup)
		admin.GET("/model-groups/:id/models", handler.ListModelGroupModels)
		admin.POST("/model-groups/:id/models", handler.BindModelGroupModel)
		admin.DELETE("/model-groups/:id/models/:modelID", handler.UnbindModelGroupModel)
